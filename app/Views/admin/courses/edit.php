...
<?= $this->section('content') ?>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mb-1 text-light">Edit Course</h1>
            <div class="text-secondary">Update course information</div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form method="post" action="<?= base_url('admin/courses/update/' . $course['id']) ?>">
                <?= csrf_field() ?>
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control <?= ($validation && $validation->hasError('title')) ? 'is-invalid' : '' ?>" 
                               id="title" name="title" value="<?= esc(old('title') ?? $course['title'] ?? '') ?>" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control <?= ($validation && $validation->hasError('description')) ? 'is-invalid' : '' ?>" 
                                  id="description" name="description" rows="4"><?= esc(old('description') ?? $course['description'] ?? '') ?></textarea>
                    ...
                    <div class="col-12">
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> To assign or change the teacher for this course, please use the <a href="<?= base_url('admin/courses/assign') ?>" class="alert-link">Assign Courses</a> page.
                            <?php if (!empty($course['instructor_name'])): ?>
                                <br><small class="mt-1 d-block">Current assigned teacher: <strong><?= esc($course['instructor_name']) ?></strong></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="schedule_day" name="schedule_day">
                            ...
                            <option value="Sunday" <?= (old('schedule_day') ?? $course['schedule_day'] ?? '') === 'Sunday' ? 'selected' : '' ?>>Sunday</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="schedule_time" name="schedule_time" 
                               ...
                               value="<?= esc(old('schedule_time') ?? $course['schedule_time'] ?? '') ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="schedule_room" name="schedule_room" 
                               ...
                               value="<?= esc(old('schedule_room') ?? $course['schedule_room'] ?? '') ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="schedule_start_date" name="schedule_start_date" 
                               value="<?= esc(old('schedule_start_date') ?? $course['schedule_start_date'] ?? '') ?>">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="schedule_end_date" name="schedule_end_date" 
                               value="<?= esc(old('schedule_end_date') ?? $course['schedule_end_date'] ?? '') ?>">
                    </div>
                </div>
